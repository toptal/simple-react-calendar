	  ...
	  function Calendar(props) {
	    ...
	    this._selectionChanged = function (selection) {
	      ...
	      if (typeof _this.props.onSelect == 'function') {
	        _this.props.onSelect(_this.props.mode == SINGLE_MODE ? start : selection);
	      }
	    };
	    ...
	    var initialMonth = activeMonth || selected && (0, _dateFnsSrcStart_of_month2['default'])(mode == SINGLE_MODE ? selected : selected.start) || (0, _dateFnsSrcStart_of_month2['default'])(today);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _days_of_week = __webpack_require__(21);

	var _days_of_week2 = _interopRequireDefault(_days_of_week);

	var _dateFnsSrcStart_of_week = __webpack_require__(13);

	var _dateFnsSrcStart_of_week2 = _interopRequireDefault(_dateFnsSrcStart_of_week);

	var _dateFnsSrcEnd_of_week = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dateFnsSrcEach_day = __webpack_require__(12);
	...
	var _dateFnsSrcIs_within_range = __webpack_require__(15);

	var _dateFnsSrcIs_within_range2 = _interopRequireDefault(_dateFnsSrcIs_within_range);

	var _dateFnsSrcFormat = __webpack_require__(16);
	...
	var Week = (function (_React$Component) {
	  ...
	  _createClass(Week, [{
	    ...
	    value: function _renderDays() {
	      ...
	      var onDayMouseMove = _props2.onDayMouseMove;
	      ...
	      return (0, _dateFnsSrcEach_day2['default'])(startDate, endDate).map(function (day) {
	        return _react2['default'].createElement(_day2['default'], {
	          ...
	          ref: 'day' + day.getTime(),
	          date: day,
	          data: data[(0, _dateFnsSrcFormat2['default'])(day, 'YYYY-MM-DD')],
	          selected: selectedMin && selectedMin && (0, _dateFnsSrcIs_within_range2['default'])(day, selectedMin, selectedMax),
	          selectable: _this._dateSelectable(day),
	          activeMonth: activeMonth,
	          today: today,
	          onClick: onDayClick,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dateFnsSrcIs_weekend = __webpack_require__(7);
	...
	var Day = (function (_React$Component) {
	  ...
	  _createClass(Day, [{
	    key: '_generalModifiers',
	    value: function _generalModifiers() {
	      var _classes;
	      ...
	      }, _defineProperty(_classes, (0, _dateFnsSrcIs_weekend2['default'])(date) ? 'is-weekend' : 'is-workday', true), _defineProperty(_classes, selectable ? 'is-selectable' : 'is-not-selectable', true), _classes);
	      return (0, _classnames2['default'])(classes);
	    }
	  }, {
	    key: '_customModifiers',
	    value: function _customModifiers() {
	      var modifiers = this.props.data.modifiers || [];
	    ...
	    value: function render() {
	      ...
	      var classes = ['day', this._generalModifiers(), this._customModifiers()].join(' ');
	      return _react2['default'].createElement(
	        'div',
	        {
	          className: classes,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dateFnsSrcAdd_months = __webpack_require__(26);
	  ...
	  function MonthHeader() {
	    ...
	    this._switchMonth = function (e) {
	      ...
	      if (data.enabled === 'true') {
	        ...
	        onMonthChange((0, _dateFnsSrcAdd_months2['default'])(activeMonth, parseInt(data.offset)));
	      }
	    };
	  }
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          monthsNames[activeMonth.getMonth()],
	          ' ',
