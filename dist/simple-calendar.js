	...
	var Calendar = (function (_React$Component) {
	  ...
	  _createClass(Calendar, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      if (!(0, _dateFnsSrcIs_same_month2['default'])(nextProps.activeMonth, this.props.activeMonth)) {
