      ...
      if (mode === RANGE_MODE) {
        ...
        if (_this._selectionInProgress) {
          var isDisabledWithin = _this._getDisabledRange({
            ...
            //       this is passed from the parent component
            // @ts-ignore
            end: !(0, _is_before["default"])(_this._selectionStart, date) ? _assertThisInitialized(_this)._selectionStart : date,
            // TODO: simplify with FC approach, remove state logic from child components
            //       this is passed from the parent component
            // @ts-ignore
            start: (0, _is_before["default"])(_this._selectionStart, date) ? _assertThisInitialized(_this)._selectionStart : date
          });
