...
var _DaysOfWeek = _interopRequireDefault(require("../RenderPropsComponents/DaysOfWeek"));

var _Month = _interopRequireDefault(require("../RenderPropsComponents/Month"));

var _MonthHeader = _interopRequireDefault(require("../RenderPropsComponents/MonthHeader"));

var _Notice = _interopRequireDefault(require("../RenderPropsComponents/Notice"));

var _Week = _interopRequireDefault(require("../RenderPropsComponents/Week"));
  ...
  _createClass(Calendar, [{
    ...
    value: function _renderMonth() {
      var _this$props4 = this.props,
          ...
          _this$props4$renderMo = _this$props4.renderMonth,
          renderMonth = _this$props4$renderMo === void 0 ? function (props) {
        return /*#__PURE__*/_react["default"].createElement(_Month["default"], props);
      } : _this$props4$renderMo,
      ...
      var highlight = this._highlight(); // TODO: rework defaultProps to default function params
    ...
    value: function _renderMonthHeader() {
      var _this$props5 = this.props,
          ...
          _this$props5$renderMo = _this$props5.renderMonthHeader,
          renderMonthHeader = _this$props5$renderMo === void 0 ? function (props) {
        return /*#__PURE__*/_react["default"].createElement(_MonthHeader["default"], props);
      } : _this$props5$renderMo;
...
_defineProperty(Calendar, "defaultProps", {
  ...
  renderDaysOfWeek: function renderDaysOfWeek(props) {
    return /*#__PURE__*/_react["default"].createElement(_DaysOfWeek["default"], props);
  },
  renderNotice: function renderNotice(props) {
    return /*#__PURE__*/_react["default"].createElement(_Notice["default"], props);
  },
  renderMonthHeader: function renderMonthHeader(props) {
    return /*#__PURE__*/_react["default"].createElement(_MonthHeader["default"], props);
  },
  renderWeek: function renderWeek(props) {
    return /*#__PURE__*/_react["default"].createElement(_Week["default"], props);
  },
  renderMonth: function renderMonth(props) {
    return /*#__PURE__*/_react["default"].createElement(_Month["default"], props);
  },
  weekStartsOn: 1
});