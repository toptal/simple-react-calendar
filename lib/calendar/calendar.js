...
function (_Component) {
  ...
  _createClass(Calendar, [{
    ...
    value: function _renderNotice() {
      ...
      return shownNoticeType && // @ts-ignore
      _react["default"].createElement(NoticeComponent, {
    ...
    value: function _renderMonth() {
      ...
      return (// @ts-ignore: No overload matches this call
    ...
    value: function render() {
      ...
      var children = _react["default"].createElement(_react.Fragment, null, this._renderNotice(), this._renderMonthHeader(), this._renderMonth());
