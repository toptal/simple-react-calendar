  ...
  _createClass(Calendar, [{
    ...
    value: function render() {
      var _this$props6 = this.props,
        ...
        return _react["default"].createElement(_Notice["default"], props);
      } : _this$props6$renderNo;
      var shownNoticeType = this.state.shownNoticeType;

      var children = _react["default"].createElement(_react["default"].Fragment, null, renderNotice({
        blockClassName: blockClassName,
...
_defineProperty(Calendar, "defaultProps", {
  ...
  renderDayOfWeek: function renderDayOfWeek(props) {
    return _react["default"].createElement(_DayOfWeek["default"], props);
  },
